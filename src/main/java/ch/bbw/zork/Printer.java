...
public class Printer {
    ...
    public static void printItems(List<Item> items, long delay) {
        items.forEach(it -> {
            System.out.println("{ name: " + it.name + ", gewicht: " + it.getWeight() + " }");
            sleep(delay);
        });
    }
    ...
    public static void show() {
        System.out.println(
                ...
                "$ show room \t\t\t Zeigt den RaumName an, in welchem du dich befindest.\n\n");
    }
    ...
    public static void map() {
        System.out.println(
                "Mit dem Befehl map bekommt man eine Übersicht über alle Räume.\n"+
                "$ map\n\n");
    }
    ...
    public static void printMap() {
        System.out.println(
                ...
                "|                    |                 |                    |                 |                    |                 |                    |\n" +
                "|                    |                 |                    |                 |                    |                 |                    |\n" +
                "|      Exit room     | <-------------> |     Living room    | <-------------> |       Office       | <-------------> |       Kitchen      |\n" +
                "|                    |                 |                    |                 |                    |                 |                    |\n" +
                "|                    |                 |                    |                 |                    |                 |                    |\n" +
                " ____________________                   ____________________                   ____________________                   ____________________\n" +
                "                                                  /\\                                     /\\\n" +
